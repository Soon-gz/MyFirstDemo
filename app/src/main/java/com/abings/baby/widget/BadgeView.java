...
public class BadgeView extends TextView {
    ...
    public static final int POSITION_CP = 6;
...
//    private static final int DEFAULT_TEXT_COLOR = Color.WHITE;
    ...
    private static final int DEFAULT_BADGE_COLOR = Color.parseColor("#FFd0d0d0");
