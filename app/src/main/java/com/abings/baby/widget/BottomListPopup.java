 ...
 */
public class BottomListPopup extends BasePopupWindow {

    private ListView mListView;
    private OnListPopupItemClickListener mOnListPopupItemClickListener;

    private BottomListPopup(Activity context) {
        super(context);
    }

    private BottomListPopup(Activity context, Builder builder) {
        this(context);
    ...
    public static class Builder {
        ...
        public BottomListPopup build() {
            return new BottomListPopup(mContext, this);
        }
...
//    }
    ...
    public View getPopupView() {
        return getPopupViewById(R.layout.popup_bottom_list);
    }
