...
//						MediaStore.Images.Media.DATE_MODIFIED);
    ...
    static class YMComparator implements Comparator<WaterFallGridHeaderItem> {

        @Override
        public int compare(WaterFallGridHeaderItem o1, WaterFallGridHeaderItem o2) {
            return o1.getItem().getCreate_datetime().compareTo(o2.getItem().getCreate_datetime());
        }
    }
