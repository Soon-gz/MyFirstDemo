 ...
 */
package com.abings.baby.ui.loading;
...
public class VaryViewHelperController {
    ...
    public void showNetworkError(View.OnClickListener onClickListener,String mes) {
        View layout = helper.inflate(R.layout.base_loading_message);
    ...
    public void showLoading(String msg) {
        View layout = helper.inflate(R.layout.base_loading);
