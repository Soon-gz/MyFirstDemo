...
public class VideoRecordSurface extends SurfaceView implements SurfaceHolder.Callback, MediaRecorder.OnErrorListener {
    ...
    private String basePath = Const.videoPath;//默认路径
    ...
    public VideoRecordSurface(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public VideoRecordSurface(Context context, AttributeSet attrs, int defStyleAttr) {
