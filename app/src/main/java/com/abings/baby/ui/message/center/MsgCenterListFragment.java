 ...
 * 说明：
 */
public class MsgCenterListFragment extends BaseFragment implements ABOnRVItemClickListener, MsgCenterMvpView, BGARefreshLayout.BGARefreshLayoutDelegate {
...
//    EditText mSearchInput;
    ...
    private RecyclerViewAdapterInfoList_send adapter;

    public static final MsgCenterListFragment newInstance(Bundle bl) {
        MsgCenterListFragment f = new MsgCenterListFragment();
        f.setArguments(bl);
        return f;
    }
    ...
    protected void onFirstUserVisible() {
        msgCenterPresenter.loadSent(true);
    }
    ...
    private void iniAdapter() {
        if (adapter == null) {
            ...
            adapter = new RecyclerViewAdapterInfoList_send(mDataRv, getActivity());
    ...
    private List<MessageSendItem> mDatas;
