 ...
 * @param <M> 适配的数据类型
 */
public abstract class ABRecyclerViewAdapter<M> extends RecyclerView.Adapter<ABRecyclerViewHolder> {
    ...
    protected ABOnRVItemClickListener mOnRVItemClickListener;
    protected ABOnRVItemLongClickListener mOnRVItemLongClickListener;

    protected RecyclerView mRecyclerView;

    public ABRecyclerViewAdapter(RecyclerView recyclerView, int itemLayoutId) {
    ...
    public ABRecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ABRecyclerViewHolder viewHolder = new ABRecyclerViewHolder(mRecyclerView, LayoutInflater.from(mContext)
    ...
    /**
     * 为item的孩子节点设置监听器，并不是每一个数据列表都要为item的子控件添加事件监听器，�?以这里采用了空实现，�?要设置事件监听器时重写该方法即可
     *
    ...
    @Override
    public void onBindViewHolder(ABRecyclerViewHolder viewHolder, int position) {
     ...
     */
    public void setOnRVItemClickListener(ABOnRVItemClickListener onRVItemClickListener) {
     ...
     */
    public void setOnRVItemLongClickListener(ABOnRVItemLongClickListener onRVItemLongClickListener) {
    ...
    /**
     * 设置item子控件�?�中状�?�变化事件监听器
     *
     * @param onItemChildCheckedChangeListener
     */
    public void setOnItemChildCheckedChangeListener(ABOnItemChildCheckedChangeListener
                                                            onItemChildCheckedChangeListener) {
    ...
    /**
     * 在集合头部添加新的数据集合（下拉从服务器获取�?新的数据集合，例如新浪微博加载最新的几条微博数据�?
     *
     * @param datas
     */
