 ...
 */
public class ABRecyclerViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
    ...
    public ABRecyclerViewHolder(RecyclerView recyclerView, View itemView, ABOnRVItemClickListener onRVItemClickListener, ABOnRVItemLongClickListener onRVItemLongClickListener) {
        super(itemView);
        ...
        mViewHolderHelper = new ABViewHolderHelper(mRecyclerView, this.itemView);
